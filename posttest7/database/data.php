<?php
    require "koneksi.php";
    $sql = mysqli_query($conn, "SELECT * FROM pengguna WHERE username != 'admin'");
...
<body>
    ...
    <a href="../reservasi/data_reservasi.php" id="daftar_pengguna"><i class="fa-solid fa-users"></i> Daftar Reservasi</a>
