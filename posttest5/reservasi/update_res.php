...
if (isset($_POST["submit"])) {
    ...
    $sql = "UPDATE reservasi SET nama='$nama',email='$email',no_telp='$no_telp',tgl_checkin='$tgl_checkin',tgl_checkout='$tgl_checkout',tipe_kamar='$tipe_kamar' WHERE id_reservasi = $id_reservasi";
